...
public class TelaEditarPedido extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(btnListar, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(61, 61, 61))
        );
        ...
        jTPedidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IDPEDIDO", "FRETE", "ClienteID", "ProdutoID"
            }
        ) {
    ...
    private void jTPedidosMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTPedidosMouseReleased
        if(jTPedidos.getSelectedRow() != -1){
            txtIdPedido.setText(jTPedidos.getValueAt(jTPedidos.getSelectedRow(), 0).toString());
            txtFrete.setText(jTPedidos.getValueAt(jTPedidos.getSelectedRow(), 1).toString());
            txtIdCliente.setText(jTPedidos.getValueAt(jTPedidos.getSelectedRow(), 2).toString());
            txtIdProduto.setText(jTPedidos.getValueAt(jTPedidos.getSelectedRow(), 3).toString());
        }
